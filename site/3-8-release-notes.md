...
<!-- wp:heading {"level":3} -->
<h3 class="wp-block-heading" id="h-generic-oidc-browser-redirect-login">Generic OIDC Browser-Redirect Login</h3>
<!-- /wp:heading -->
...
<!-- wp:heading {"level":3} -->
<h3 class="wp-block-heading" id="h-deployment-editor-attribute-editing">Deployment Editor Attribute Editing</h3>
<!-- /wp:heading -->
...
<!-- wp:heading {"level":3} -->
<h3 class="wp-block-heading" id="h-username-validation-and-lookup-collision">Username Validation and Lookup Collision</h3>
<!-- /wp:heading -->
...
<!-- wp:heading {"level":3} -->
<h3 class="wp-block-heading" id="h-element-load-ordering-and-attribute-hierarchy">Element Load Ordering and Attribute Hierarchy</h3>
<!-- /wp:heading -->
...
<!-- wp:heading {"level":3} -->
<h3 class="wp-block-heading" id="h-progress-api-permission-fix">Progress API Permission Fix</h3>
<!-- /wp:heading -->
...
<!-- wp:heading {"level":3} -->
<h3 class="wp-block-heading" id="h-admin-console-fixes">Admin Console Fixes</h3>
<!-- /wp:heading -->
