...
<!-- wp:heading {"level":6} -->
<h6 class="wp-block-heading" id="h-specifies-an-object-by-name">Specifies an Object by Name</h6>
<!-- /wp:heading -->

<!-- wp:paragraph -->
<p>When a type references another type, it is not possible to directly query that object. The <code>.name</code> operator enables support for such an operation. It is similar to a JOIN operation in SQL. This is used to reference other types which have their own <code>name</code> field and are first-class database objects.</p>
<!-- /wp:paragraph -->
...
<!-- wp:list-item -->
<li>Find a user with <code>name = "earl1"</code></li>
<!-- /wp:list-item -->
